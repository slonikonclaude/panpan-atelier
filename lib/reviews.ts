 ...
 * Корпус — все 510 отзывов из панели Google Поиска (18.09.2026; локально `_data/maps/reviews-all.json`,
 * в репозитории — обезличенная копия `_data/maps/reviews-public.json`)
