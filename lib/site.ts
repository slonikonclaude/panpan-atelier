...
/** Цвет адресной строки — `--color-flour` из globals.css (метаданные не читают CSS-переменные). */
export const THEME_COLOR = "#f7f2ea";
...
export function buildMetadata(locale: Locale): Metadata {
  ...
  // Превью соцсетей — public/og.jpg 1200×630 (hero + знак): JPEG, а не WebP, — его понимают все мессенджеры.
