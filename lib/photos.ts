...
export const photos = {
  ...
  hero: p(
    ...
    1800,
    2400,
    "Capuchino y focaccia de jamón y tomate en la barra de pino junto al ventanal; al lado, el panel marrón con el logotipo «pan pan» y, fuera, la Gran Vía arbolada al sol",
    "A cappuccino and a ham-and-tomato focaccia on the pine window counter; beside it, the brown panel with the “pan pan” logo, and the tree-lined Gran Vía in the sun outside",
    "50% 62%",
  ),
  ...
  // La carta
  tostadaAguacate: p("tostada-aguacate", 2400, 1807, "Tosta de aguacate en pan de masa madre, con tomate en dados y cebolla", "Sourdough toast with avocado, diced tomato and onion", "50% 50%"),
  ...
  donut: p("donut", 1800, 2400, "Panut de chocolate con perlas crujientes y un muffin detrás", "A chocolate doughnut with crunchy pearls, and a muffin behind", "50% 62%"),
  ...
  licuados: p("licuados", 1350, 2400, "Smoothie de fresa, zumo de naranja y tarta de queso ante la pared de pino", "A strawberry smoothie, an orange juice and cheesecake against the pine wall", "50% 55%"),
  vitrinaBolleria: p("vitrina-bolleria", 2400, 1800, "Vitrina de bollería en enero de 2024: ensaimadas, cruasanes de mantequilla y cruasanes con azúcar glas, con sus etiquetas de precio", "The pastry case in January 2024: ensaimadas, butter croissants and icing-sugar croissants, with their price tags", "50% 55%"),
