...
const en: Dictionary = {
  ...
  about: {
    ...
    photoCaption: "“[[es:Saborea la vida… sin prisa]]” — savour life, no rush — on the pine wall of the café.",
    points: [
      {
  ...
  visit: {
    ...
    hours: "Opening hours",
    hoursNote: "Hours cross-checked between their Google listing, the sign on the door and their Instagram, which don’t always agree; weekend hours change in summer (one June they put up a “[[es:Horario verano]]” – summer hours – sign on the door). If you’re coming late in the day or at the weekend, call first.",
    today: "Today",
