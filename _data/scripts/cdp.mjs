...
export const SCRATCH = "C:/Users/DOPELG~1/AppData/Local/Temp/claude/C--Users-dopelganger-Documents-----------/b05d54f5-a988-4d8e-8668-6a1d58c62484/scratchpad";
...
export async function launch({ port = 9723, profile = "chrome-profile", headless = false, offscreen = true, width = 1400, height = 1000 } = {}) {
  let alive = false;
