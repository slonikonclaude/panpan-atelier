...
/** Снежинка — «aire acondicionado». */
export const IconSnow = (p: P) => (
  <svg {...base} {...p}>
    <path d="M12 3v18M4.2 7.5l15.6 9M4.2 16.5l15.6-9" />
    <path d="M9.8 4.5 12 6.5l2.2-2M9.8 19.5 12 17.5l2.2 2" />
  </svg>
);

/** Зонт над столиком — «terraza». */
export const IconUmbrella = (p: P) => (
  <svg {...base} {...p}>
    <path d="M3.5 10.5a8.5 6 0 0 1 17 0Z" />
    <path d="M12 10.5V21M8 21h8M12 3v1.5" />
  </svg>
);
...
/** Круассан — «bollería del obrador». */
export const IconCroissant = (p: P) => (
  <svg {...base} {...p}>
    <path d="M4.5 15.5c-1.5-3 .2-7 4.2-8.8 1.4-.6 2.6-.7 3.3-.7s1.9.1 3.3.7c4 1.8 5.7 5.8 4.2 8.8" />
    <path d="M4.5 15.5 7.5 13l1.5 4M19.5 15.5 16.5 13 15 17M9 17l1.4-7h3.2L15 17M10.4 10l-1.9 3M13.6 10l1.9 3" />
  </svg>
);

/** Стакан сока со штрихом-соломинкой — как пиктограммы на их досках завтраков. */
export const IconJuice = (p: P) => (
  <svg {...base} {...p}>
    <path d="M6 7.5h12l-1.3 12a1.6 1.6 0 0 1-1.6 1.5H8.9a1.6 1.6 0 0 1-1.6-1.5Z" />
    <path d="M6.6 12h10.8M13 7.5 15 2.5h2.5" />
  </svg>
);

/** Ломоть хлеба — «tostada». */
export const IconToast = (p: P) => (
  <svg {...base} {...p}>
    <path d="M6 20.5V11a4 4 0 0 1-1.5-3.1C4.5 5.4 7.8 3.5 12 3.5s7.5 1.9 7.5 4.4A4 4 0 0 1 18 11v9.5Z" />
    <path d="M9 12.5h.01M12 15.5h.01M15 12.5h.01" />
  </svg>
);

/** Помидор — «tomate». */
export const IconTomato = (p: P) => (
  <svg {...base} {...p}>
    <path d="M12 7.5c-4.4 0-8 2.9-8 6.5s3.6 6.5 8 6.5 8-2.9 8-6.5-3.6-6.5-8-6.5Z" />
    <path d="M12 7.5V4M9 5.5l3 2 3-2M8.5 9l3.5-1.5L15.5 9" />
  </svg>
);

/** Баночка — «mermelada y mantequilla». */
export const IconJar = (p: P) => (
  <svg {...base} {...p}>
    <rect x="6" y="3.5" width="12" height="3.5" rx="1" />
    <path d="M7 7h10v11.5A2.5 2.5 0 0 1 14.5 21h-5A2.5 2.5 0 0 1 7 18.5Z" />
    <path d="M9.5 12h5v4h-5Z" />
  </svg>
);

/** Ломтик хамона на косточке — «paleta ibérica». */
export const IconHam = (p: P) => (
  <svg {...base} {...p}>
    <path d="M14.5 4.5c3.5 0 5.5 2.6 5 6-.6 3.9-4.6 8.5-9.3 9.4-3 .6-5.7-.8-5.7-3.3 0-3.2 3.8-4 5.5-6.3 1.4-1.9 1.3-5.8 4.5-5.8Z" />
    <path d="M15 9.5c-.8 2.7-3.3 5-6.2 6" />
  </svg>
);

/** Половинка авокадо — «aguacate». */
export const IconAvocado = (p: P) => (
  <svg {...base} {...p}>
    <path d="M12 3c-2.6 0-4 3-5 6.2-1.3 4.4-1.4 11.8 5 11.8s6.3-7.4 5-11.8C16 6 14.6 3 12 3Z" />
    <circle cx="12" cy="14.5" r="2.6" />
  </svg>
);

/** Стакан с кусочками фруктов — «vaso de fruta». */
export const IconFruitCup = (p: P) => (
  <svg {...base} {...p}>
    <path d="M5.5 9h13l-1.5 11a1.6 1.6 0 0 1-1.6 1.4H8.6A1.6 1.6 0 0 1 7 20Z" />
    <path d="M9 13.5h2v2H9ZM13 12.5l1.8 1-1 1.8-1.8-1ZM11.5 17.2h2v2h-2Z" />
    <path d="M12 9c0-2.5 1.5-4.5 4-5" />
  </svg>
);
